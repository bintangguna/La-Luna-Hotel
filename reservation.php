...
if (isset($_GET['room_id'])) {
    ...
    $get_room_result = mysqli_query($db->connection, $get_room_sql);
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h4 style="font-weight: bold">Price: <span id="price">
                                            <?php echo $get_room_price; ?>
                                        </span></h4>
                    ...
                    <?php } else { ?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold;">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold;">Price: <span id="price_not">0</span></h4>
                                    <h4 style="font-weight: bold;display:none;">Price: <span id="price">0</span></h4>
                                    <h4 style="font-weight: bold; display:none;">Total Amount : <span
                                            id="total_price">0</span></h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_not">0</span></h4>
