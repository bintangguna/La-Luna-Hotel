        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $emp_result = mysqli_query($db->connection, $emp);
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            ...
                            $staff_query = "SELECT * FROM staff JOIN staff_type ON staff.staff_type_id = staff_type.staff_type_id JOIN shift ON staff.shift_id = shift.shift_id";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($staff['updated_at'] == NULL) {
                                                ...
                                                echo date('M j, Y', strtotime($staff['updated_at']));
                                            } ?>
                                        </td>
                                    </tr>
