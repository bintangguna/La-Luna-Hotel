...
function validId(val) {
    if (val ==1){
        ...
        document.getElementById('id_card_no').setAttribute('placeholder',"5171234500098765");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 16 Digit Valid National Identity Card No");
    }else if(val ==2){
        document.getElementById('id_card_no').setAttribute('type','number');
        document.getElementById('id_card_no').setAttribute('data-minlength','12');
        document.getElementById('id_card_no').setAttribute('placeholder',"010987654567");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 12 Character(include '/') Valid License Number");
    }else if(val ==3){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','8');
        document.getElementById('id_card_no').setAttribute('placeholder',"LH615098");
        document.getElementById('id_card_no').setAttribute('data-error',"Enter 8 Character Valid Passport Number");
    }else if(val == 4){
        document.getElementById('id_card_no').setAttribute('type','text');
        document.getElementById('id_card_no').setAttribute('data-minlength','16');
...
//shows total price saat booking
function fetch_price(val) {
    $.ajax({
        ...
        success: function (response) {
            $("#price").html(response);
            $("#price_not").html(formatRupiah(response));
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.done == true) {
                ...
                $('#getTotalPrice').html(formatRupiah(response.total_price));
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.done == true) {
                ...
                $('#getTotalPrice_n').html(formatRupiah(response.total_price));
                $('#getRemainingPrice_n').html(formatRupiah(response.remaining_price));
