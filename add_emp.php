                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="First Name" id="first_name"
                                    required data-error="Enter First Name">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control" placeholder="Contact Number" id="contact_no"
                                    required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="Residential Address" id="address"
                                    required>
                                <div class="help-block with-errors"></div>
                            </div>
